...
public:
	//CDialogThreeView(separateScreen pScreenType, CWnd* pParent = NULL);   // 标准构造函数
	CDialogThreeView(CWnd* pParent = NULL);   // 标准构造函数
...
protected:
	...
	int _iDisplayFlag[MAX_CHANNEL];//hjl11.9 用于抽道显示 用于判定当前道是否显示
