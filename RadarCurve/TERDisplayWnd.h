...
protected:
	...
	int mapRadarValueToXValue( float TERValue , float indexRatio);//根据雷达数据值radarValue，及雷达数据值序号与采样点数比值indexRatio计算波形图X值
...
protected:
	...
	int m_nSampleCount;//采样点数
	int m_nSampleRatio;//采样点数
	...
	TERDataVector m_vecTERData;//用来接收新数据的数据
	TERDataVector m_vecTempTERData;//用来可视化的数组
