...
作者					日期				描述
----------------------------------------------------------------------
Liugh:		Rewrite From ScreenMark
Kernel:		osg::AutoTransfrom
************************************************************************/
...
class OBJECT_EXPORT CSO3DMark : public CObj
{
public:
	CSO3DMark();
	virtual ~CSO3DMark();
...
protected:
	...
	osg::ref_ptr<osgText::FadeText>			m_textNode;	//文字结点
	osg::ref_ptr<osg::Switch>			m_switch;
	osg::ref_ptr<osg::AutoTransform>	m_AutoTrans;
	...
	osg::ref_ptr<osg::Billboard>	m_pic;		//图片结点
