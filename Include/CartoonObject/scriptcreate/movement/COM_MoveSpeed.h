...
//运动速度基类
class CARTOONOBJECT_EXPORT CCOM_MoveSpeed : public osg::Referenced, public CObject
{
public:
	...
	*/
	...
	获取速度和加速度
	*/
	virtual BOOL GetOriginSpeedAndAcceleration(double &v, double &a);
...
//匀加速运动
class CARTOONOBJECT_EXPORT CCOM_MSUniform : public CCOM_MoveSpeed
{
public:
